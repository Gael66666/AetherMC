...
let
  aethermcInner = aethermc-unwrapped.override { inherit msaClientID enableLTO gamemodeSupport; };
in
...
symlinkJoin {
  ...
  qtWrapperArgs =
    ...
    in
    [
      "--prefix AETHERMC_JAVA_PATHS : ${lib.makeSearchPath "bin/java" jdks}"
