...
class MainWindow::Ui
{
   public:
    ...
    void createInstanceToolbar(QMainWindow *MainWindow)
    {
        ...
        // See https://github.com/AetherMC/AetherMC/issues/493
...
void MainWindow::on_actionCreateShortcut_triggered()
{
    ...
    if (APPLICATION->isFlatpak()) {
      executable_path = "flatpak run org.aethermc.AetherMC ";
    }
...
void MainWindow::globalSettingsClosed()
{
    ...
    // but AetherMC exits abnormally, causing the window state to never be saved:
