...
QString getCreditsHtml()
{
    ...
    //: %1 is the name of the launcher, determined at build time, e.g. "AetherMC Developers"
    ...
    //: %1 is the name of the launcher, determined at build time, e.g. "AetherMC Contributors"
    ...
    stream << "<p>Everyone else who <a href='https://github.com/AetherMC/AetherMC/graphs/contributors'>contributed</a>!</p>\n";
    stream << "<br />\n";
