...
public: /* data */
    /// AetherMC: order hint for this version file if no explicit order is set
    int order = 0;

    /// AetherMC: human readable name of this package
    QString name;

    /// AetherMC: package ID of this package
    QString uid;

    /// AetherMC: version of this package
    QString version;

    /// AetherMC: DEPRECATED dependency on a Minecraft version
    ...
    /// AetherMC: class to launch legacy Minecraft with (embed in a custom window)
    QString appletClass;

    /// Mojang: Minecraft launch arguments (may contain placeholders for variable substitution)
    QString minecraftArguments;

    /// AetherMC: Additional JVM launch arguments
    ...
    /// AetherMC: list of tweaker mod arguments for launchwrapper
    QStringList addTweakers;

    /// Mojang: list of libraries to add to the version
    QList<LibraryPtr> libraries;

    /// AetherMC: list of maven files to put in the libraries folder, but not in classpath
    QList<LibraryPtr> mavenFiles;

    /// AetherMC: list of agents to add to JVM arguments
    QList<AgentPtr> agents;

    /// The main jar (Minecraft version library, normally)
    LibraryPtr mainJar;

    /// AetherMC: list of attached traits of this version file - used to enable features
    QSet<QString> traits;

    /// AetherMC: list of jar mods added to this version
    QList<LibraryPtr> jarMods;

    /// AetherMC: list of mods added to this version
    QList<LibraryPtr> mods;

    /**
     * AetherMC: set of packages this depends on
     * NOTE: this is shared with the meta format!!!
     */
    Meta::RequireSet required;

    /**
     * AetherMC: set of packages this conflicts with
     * NOTE: this is shared with the meta format!!!
     */
