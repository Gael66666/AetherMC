...
private: /* methods */
    /// the default storage prefix used by AetherMC
...
protected: /* data */
    ...
    /// DEPRECATED: AetherMC-specific absolute URL. takes precedence over the implicit maven repo URL, if defined
    QString m_absoluteURL;

    /// AetherMC extension - filename override
    QString m_filename;

    /// DEPRECATED AetherMC extension - display name
    QString m_displayname;

    /**
     * AetherMC-specific type hint - modifies how the library is treated
     */
    QString m_hint;

    /**
     * storage - by default the local libraries folder in aethermc, but could be elsewhere
     * AetherMC specific, because of FTB.
     */
